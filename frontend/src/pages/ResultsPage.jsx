      ...
      <div className="max-w-2xl mx-auto px-4 py-12 sm:py-20 text-center">
        ...
        <div className="mt-8 bg-gray-800/50 border border-gray-700 rounded-lg overflow-hidden">
          ...
          <div className="p-6">
            ...
            <p className="font-medium text-lg truncate mb-4">
              {result.fileName}
            </p>
            <div
              className={`inline-flex items-center gap-3 p-3 rounded-lg ${statusInfo.colorClasses}`}
            >
              {statusInfo.icon}
              <div className="text-left">
                ...
                <p className="text-sm opacity-80">
                  Confidence Score:{" "}
                  <span className="font-mono">{`${Math.round(
        ...
        <div className="mt-8 p-4 text-sm flex items-start gap-3 bg-yellow-500/10 text-yellow-300 rounded-lg border border-yellow-500/20">
          ...
          <p className="text-left">
            This result is generated by AI and is not a guarantee. Always use
            critical thinking when evaluating content.
          </p>
        </div>
